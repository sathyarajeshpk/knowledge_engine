# Workspace-level surge protection controls (Preview)
...
Source: [fabric-whats-new-markdown](https://blog.fabric.microsoft.com/blog/surge-protection-gets-smarter-introducing-workspace-level-controls-preview?ft=All)
